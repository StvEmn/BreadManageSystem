...
public class ShipmentController {
    ...
    //根据goods_name查询
    @GetMapping("/shipment?goods_name={goods_name}")
    public List<Shipment> findById(@PathVariable("goods_name") String goods_name) {
        return service.selectByGoods_name(goods_name);
    }
